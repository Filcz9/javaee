...
<p>Release Date: <jsp:getProperty name="computergame" property="release_date"></jsp:getProperty></p>
<p>Price: <jsp:getProperty name="computergame" property="price"></jsp:getProperty></p>
<p>Rating: <jsp:getProperty name="computergame" property="rating"></jsp:getProperty></p>
